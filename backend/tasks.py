...
def fact_check_video(self, video_url, target_lang='en'):
    try:
        ...
        prompt_claims = f"Analyze the transcript. These are subtitles from a YouTube video. First of all, try to understand what the plot of this material is about, what it is about, who it might be about, who the heroes of this text might be. Extract 5 main factual claims that can be verified. Focus on specific, checkable statements. Present them as a numbered list. Return claims written in {target_lang}. Transcript: --- {clean_text} ---"
